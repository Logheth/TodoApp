...
function HolyGrailLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Header */}
      <header className="bg-slate-950 text-white p-4 text-center text-4xl font-bold fixed top-0 z-10 w-full h-[70px]">
        To - Do List App
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-60 bg-orange-400 p-4 fixed h-full left-0 mt-[70px]">
          <div className="shadow-2xl py-5">
            <p className="text-2xl mb-5 font-semibold text-center">
              Left Sidebar
            </p>
